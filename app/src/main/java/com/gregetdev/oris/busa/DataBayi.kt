...
class DataBayi : AppCompatActivity() {
    ...
    private fun DisplayDataBayi(){
        ...
        Belum_ada_data.visibility = View.VISIBLE

        Table_bayi.addValueEventListener(object : ValueEventListener{
            ...
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                if (dataSnapshot.exists()){
                    Belum_ada_data.visibility = View.GONE
                }else{
                    Belum_ada_data.visibility = View.VISIBLE
                }
            }
